    ...
    then: (data) =>
      data.map((employee, i) => {
        ...
        exportData.push({
          ...
          "แผนกปฏิบัติงาน" : job_position,
          "ข้อมูลพฤติกรรมการสูบบุหรี่" : smoke_often1,
          "ข้อมูลพฤติกรรมการดื่มแอลกลอฮอร์" : drinking_alcohol2,
          "ข้อมูลโรคติดเชื้อโควิด" : covid1,
          "ข้อมูลฉีดวัคซีน" : covid2,
